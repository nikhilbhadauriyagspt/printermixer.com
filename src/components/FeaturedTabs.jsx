          ...
          <div className="flex p-1.5 bg-slate-100 rounded-[20px] shadow-inner">
            {tabs.map((tab) => (
              <button
                ...
                className={`px-8 py-3.5 rounded-[16px] text-[13px] font-black uppercase tracking-wider transition-all flex items-center gap-3 ${
                  activeTab === tab.id
              ...
              <SwiperSlide key={p.id}>
                ...
                >
                  ...
                  <button
                    ...
                    className={`absolute top-6 right-6 z-10 p-2.5 rounded-xl transition-all shadow-sm ${
                      isInWishlist(p.id) 
