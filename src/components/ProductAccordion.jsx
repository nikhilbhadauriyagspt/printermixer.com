  ...
  return (
    <section className="py-16 md:py-24 bg-white font-sans border-t border-slate-100">
      <div className="w-full mx-auto px-6 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="h-px w-8 bg-indigo-600 rounded-full" />
              <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-[0.3em]">Premium Legacy</span>
            </div>
          ...
          <Link to={`/shop?category=${categorySlug}`} className="group flex items-center gap-3 text-[10px] font-bold text-slate-400 hover:text-indigo-600 transition-all uppercase tracking-widest bg-white hover:bg-indigo-50 px-6 py-3.5 rounded-xl border border-slate-200 hover:border-indigo-200 shadow-sm mb-1">
          ...
          {displayProducts.map((p, i) => (
            ...
            >
              ...
              <div className="aspect-square w-full mb-8 relative">
                ...
                <button 
                  onClick={() => addToCart(p)}
                  className="absolute bottom-0 right-0 h-12 w-12 rounded-full bg-indigo-600 text-white flex items-center justify-center translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-slate-900"
                >
                  <Plus size={24} />
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <div className="h-1.5 w-1.5 rounded-full bg-slate-200 group-hover:bg-indigo-600 transition-colors" />
                </div>
              </div>
        ...
        {/* --- BOTTOM QUOTE BANNER --- */}
        <div className="mt-12 bg-indigo-600 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group hover:bg-indigo-700 transition-all duration-500">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <Link to="/contact" className="px-10 py-4 bg-white text-indigo-600 rounded-2xl font-bold text-sm hover:bg-slate-900 hover:text-white transition-all shadow-xl shadow-indigo-900/20">
                Contact Specialist
              </Link>
