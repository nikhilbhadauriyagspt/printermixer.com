        ...
        <div className="mb-12">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-slate-400">
              ...
              <span className="text-indigo-600">Account Dashboard</span>
            </div>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mt-4 text-center md:text-left">
              <h1 className="text-4xl lg:text-6xl font-black text-slate-900 tracking-tighter leading-none">
                Control <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-500 italic">Panel.</span>
              </h1>
          ...
          <div className="lg:col-span-4">
            <div className="bg-white rounded-[40px] p-10 border border-slate-100 shadow-2xl shadow-indigo-100/20 sticky top-32">
              <div className="flex flex-col items-center text-center mb-12">
                <div className="h-24 w-24 rounded-[32px] bg-indigo-600 text-white flex items-center justify-center text-3xl font-black mb-6 shadow-xl shadow-indigo-200">
              ...
              {activeTab === 'profile' && (
                ...
                >
                  <div className="flex items-center gap-5 mb-12">
                    <div className="h-14 w-14 rounded-[20px] bg-indigo-50 text-indigo-600 flex items-center justify-center shadow-sm">
                  ...
                  <form onSubmit={handleProfileUpdate} className="space-y-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full p-6 bg-slate-50 border border-slate-100 rounded-[32px] focus:bg-white focus:border-indigo-600 outline-none text-sm font-bold text-slate-800 transition-all resize-none"
                    ...
                    <div className="pt-4">
                      <button
                        disabled={isUpdating}
                        className="h-16 px-12 bg-indigo-600 text-white rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 disabled:opacity-50 active:scale-95"
                      >
              ...
              {activeTab === 'orders' && (
                ...
                >
                  <div className="bg-white rounded-[40px] p-10 border border-slate-100 shadow-2xl shadow-indigo-100/20 flex items-center justify-between">
                    ...
                    <Link to="/shop" className="px-6 py-3 bg-slate-50 hover:bg-indigo-50 text-indigo-600 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">New Acquisition</Link>
                  </div>
                  ...
                  {orders.length === 0 ? (
                    <div className="bg-white rounded-[40px] p-24 text-center border border-slate-100 shadow-sm">
                      ...
                      <Link to="/shop" className="inline-block mt-8 text-indigo-600 font-black uppercase text-[10px] tracking-widest underline underline-offset-8">Explore Hardware Catalog</Link>
                    </div>
                  ) : (
                        ...
                        <div key={order.id} className="bg-white rounded-[32px] border border-slate-100 overflow-hidden group hover:border-indigo-200 hover:shadow-2xl hover:shadow-indigo-100/30 transition-all duration-500">
                          <div className="p-8 flex items-center justify-between border-b border-slate-50">
                            <div>
                              ...
                              <span className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase border tracking-widest ${order.status === 'delivered' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-indigo-50 text-indigo-600 border-indigo-100'}`}>
                                {order.status}
                              </span>
                            </div>
                          ...
                          <div className="p-6 bg-slate-50/50 group-hover:bg-white transition-colors">
                            <Link to="/orders" className="flex items-center justify-center gap-3 text-[11px] font-black text-indigo-600 uppercase tracking-widest group-hover:gap-5 transition-all">
                ...
                >
                  ...
                  <form onSubmit={handleSecurityUpdate} className="space-y-8">
                    <div className="space-y-3">
                      ...
                      <div className="relative group">
                        <input
                          ...
                          className="w-full h-16 pl-6 pr-14 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-indigo-600 outline-none text-sm font-bold text-slate-800 transition-all"
                          placeholder="Enter high-entropy password"
                        />
                        <button type="button" onClick={() => setShowPass(!showPass)} className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-300 hover:text-indigo-600 transition-colors">
                    ...
                    <div className="pt-4">
                      <button
                        disabled={isUpdating}
                        className="h-16 px-12 bg-slate-900 text-white rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-indigo-600 transition-all shadow-xl shadow-slate-200 active:scale-95 disabled:opacity-50"
                      >
