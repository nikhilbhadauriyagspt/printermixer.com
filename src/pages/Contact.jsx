        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 text-center md:text-left">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 leading-none tracking-tighter">
              Get In <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0978CD] to-blue-500 italic">Touch.</span>
            </h1>
          </div>
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white rounded-2xl border border-slate-100 shadow-sm self-center md:self-auto">
            <Headphones size={18} className="text-[#0978CD]" strokeWidth={2.5} />
      ...
      <div className="w-full mx-auto px-6 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-32">
            ...
            >
              <div className="h-16 w-16 rounded-[20px] bg-indigo-50 flex items-center justify-center mb-10 text-[#0978CD] group-hover:bg-[#0978CD] group-hover:text-white transition-all duration-500 shadow-sm">
              ...
              <div className="relative z-10">
                {status === 'success' ? (
                  ...
                  >
                    ...
                    <button onClick={() => setStatus(null)} className="px-12 py-5 bg-[#0978CD] text-white font-black text-[11px] uppercase tracking-[0.2em] rounded-2xl hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 active:scale-95">Initiate New Inquiry</button>
                  </motion.div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-10">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="relative group">
                          <select
                            ...
                            className="w-full h-16 px-6 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#0978CD] outline-none text-sm font-bold text-slate-800 transition-all appearance-none cursor-pointer"
                          >
                          ...
                          <ChevronDown className="absolute right-6 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none group-focus-within:text-[#0978CD]" size={20} strokeWidth={2.5} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full p-8 bg-slate-50 border border-slate-100 rounded-[32px] focus:bg-white focus:border-[#0978CD] outline-none text-sm font-bold text-slate-800 transition-all resize-none"
                      ></textarea>
                    </div>
                    ...
                    <div className="pt-4">
                      <button
                        disabled={loading}
                        className="w-full h-16 bg-slate-900 text-white rounded-2xl flex items-center justify-center gap-4 text-[11px] font-black uppercase tracking-[0.2em] hover:bg-[#0978CD] transition-all shadow-xl shadow-slate-200 active:scale-95 disabled:opacity-50 group"
                      >
